...
for orig_col in ['narrative', 'synopsis', 'callback' , 'combined', 'narrative_synopsis_combined']:
    ...
    neg_total, neg_unq_total = fn[sel, 0].sum(), fn[sel].shape[0]
    ...
    print(f'total number of top down words: {orig_col}', total_cts[top_down_sel, 0].sum())
    print(f'total number of unique top down words: {orig_col}', total_cts[top_down_sel].shape[0])
