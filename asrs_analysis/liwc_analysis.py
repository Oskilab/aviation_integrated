...
def analyze_tracon_period(df_grouped, sel_cols, df, group_to_set, replace_dict):
    ...
    # return fin
    # fin_df.to_csv(f'results/liwc_{level[idx]}_{col}_counts.csv')
...
all_sel = all_sel[1:2]
for idx, sel in enumerate(all_sel):
    ...
    for col in ['narrative', 'synopsis', 'combined']:
        ...
        # variables used: tmp,sel, all_pds, group_to_set
        # index_to_counter = {}
